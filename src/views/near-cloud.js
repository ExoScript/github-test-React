    ...
    <div className="near-cloud-container">
      ...
      <div className="near-cloud-container001">
        ...
        <div className="near-cloud-container007">
          <div className="near-cloud-container008"></div>
          ...
          <div className="near-cloud-container009">
        ...
        <div className="near-cloud-container010 border-b">
          <div className="near-cloud-container011">
            ...
            <div className="near-cloud-container023">
              <img alt="image" src="/img_2.svg" className="near-cloud-image" />
            </div>
          </div>
        </div>
        <div className="near-cloud-container024 border-b">
        ...
        <div className="near-cloud-container032 border-b">
              ...
              <div className="near-cloud-container036">
                <div className="near-cloud-container037">
                  <div className="near-cloud-container038">
                    <div className="near-cloud-container039">
                      <img
                        alt="image"
                        src="/vector.svg"
                ...
                <div className="near-cloud-container040"></div>
                <div className="near-cloud-container041">
                  <div className="near-cloud-container042">
                    <div className="near-cloud-container043">
                      <img
                        alt="image"
                        src="/vector.svg"
                ...
                <div className="near-cloud-container044"></div>
                <div className="near-cloud-container045">
                  <div className="near-cloud-container046">
                    <div className="near-cloud-container047">
                      <img
                        alt="image"
                        src="/vector.svg"
                ...
                <div className="near-cloud-container048"></div>
        ...
        <div className="near-cloud-container066">
          <div className="near-cloud-container067">
            ...
            <div className="near-cloud-container073">
              ...
              <div className="near-cloud-container090">
                <div className="near-cloud-container091"></div>
                <div className="near-cloud-container092">
                  <div className="near-cloud-container093">
                    <div className="near-cloud-container094">
                      <span className="near-cloud-text63">
                        Business Consulting
                      </span>
                      <span className="near-cloud-text64">June 9, 2022</span>
                    </div>
                    <div className="near-cloud-container095"></div>
                  </div>
