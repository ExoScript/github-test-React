  ...
  return (
    <div className="product1-container">
      ...
      <div className="product1-container001">
        ...
        <div className="product1-container009">
          <div className="product1-container010">
            <div className="product1-container011">
              <img alt="image" src="/img_1.svg" className="product1-image" />
            </div>
          ...
          <div className="product1-container015">
            <div className="product1-container016">
              <div className="product1-container017">
                <span className="product1-text18 sub-titel-1">
                  - OUR FEATURES
                </span>
                <span className="titel-2">
              ...
              <div className="product1-container018">
                ...
                <div className="product1-container023">
            ...
            <div className="product1-container027">
              <img alt="image" src="/img_4.svg" className="product1-image1" />
            </div>
          </div>
        </div>
        <div className="product1-container028">
          <div className="product1-container029">
            <div className="product1-container030">
              <span className="titel-2">
                Learn about our company success stories
              </span>
              <span className="product1-text29 text-1">
                  ...
                  <div className="product1-container034">
                    <div className="product1-container035">
                      <img
                        alt="image"
                        src="/vector.svg"
                        className="product1-image2"
                      />
                      <span className="product1-text30">10K+</span>
                    </div>
                  </div>
                  <span className="product1-text31">Sales Calls</span>
                </div>
                <div className="product1-container036"></div>
                <div className="product1-container037">
                  <div className="product1-container038">
                    <div className="product1-container039">
                      ...
                      />
                      <span className="product1-text32">125K+</span>
                    </div>
                  </div>
                  <span className="product1-text33">Data enriched</span>
                </div>
                <div className="product1-container040"></div>
                <div className="product1-container041">
                  <div className="product1-container042">
                    <div className="product1-container043">
                      ...
                      />
                      <span className="product1-text34">15+</span>
                    </div>
                  </div>
                  <span className="product1-text35">Years Experience</span>
                </div>
                <div className="product1-container044"></div>
                <div className="product1-container045">
                  <div className="product1-container046">
                    <div className="product1-container047">
                      ...
                      />
                      <span className="product1-text36">8+</span>
                    </div>
                  </div>
                  <span className="product1-text37">ROI on average</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="product1-container048">
          <div className="product1-container049">
            <div className="product1-container050">
              <span className="product1-text38 titel-2">
          ...
          <div className="product1-container051">
            <div className="product1-container052">
              <div className="product1-container053">
                <div className="product1-container054">
                  <div className="product1-container055"></div>
                </div>
                <div className="product1-container056">
                  <span className="product1-text40 ueberschrift-1">
                    Onboarding
                  </span>
                </div>
                <div className="product1-container057"></div>
                <div className="product1-container058">
                  <span className="product1-text41 text-2">
              ...
              <div className="product1-container059">
                <div className="product1-container060">
                  <div className="product1-container061"></div>
                </div>
                <div className="product1-container062">
                  <span className="product1-text42 ueberschrift-1">
                    Outbound
                  </span>
                </div>
                <div className="product1-container063"></div>
                <div className="product1-container064">
                  <span className="product1-text43 text-2">
              ...
              <div className="product1-container065">
                <div className="product1-container066">
                  <div className="product1-container067"></div>
                </div>
                <div className="product1-container068">
                  <span className="product1-text44 ueberschrift-1">
                    Monitoring
                  </span>
                </div>
                <div className="product1-container069"></div>
                <div className="product1-container070">
                  <span className="product1-text45 text-2">
          ...
          <div className="product1-container072">
            <div className="product1-container073">
              <div className="product1-container074">
                <div className="product1-container075">
                  <span className="product1-text46 sub-titel-1">
                    Blog and case study
                  </span>
              ...
              <div className="product1-container076">
                <div className="product1-container077">
                  <span className="product1-text48">Read All Blog</span>
            ...
            <div className="product1-container078">
                ...
                <div className="product1-container081">
                  <div className="product1-container082">
                    <div className="product1-container083">
                      <span className="product1-text49">IT Support</span>
                      <span className="product1-text50">June 9, 2022</span>
                    </div>
                    <div className="product1-container084"></div>
                  </div>
                  <div className="product1-container085">
                    <span className="product1-text51">
                      Being different in Sales is crucial for your success
                    </span>
                  </div>
                  <div className="product1-container086">
                    <span className="product1-text52">Read More</span>
              ...
              <div className="product1-container087">
                <div className="product1-container088"></div>
                <div className="product1-container089">
                  <div className="product1-container090">
                    <div className="product1-container091">
                      <span className="product1-text53">
                        Marketing Consulting
                      </span>
                      <span className="product1-text54">June 9, 2022</span>
                    </div>
                    <div className="product1-container092"></div>
                  </div>
                  <div className="product1-container093">
                    <span className="product1-text55">
                      Adding new ways of outreach can boost your growth
                    </span>
                  </div>
                  <div className="product1-container094">
                    <span className="product1-text56">Read More</span>
              ...
              <div className="product1-container095">
                <div className="product1-container096"></div>
                <div className="product1-container097">
                  <div className="product1-container098">
                    <div className="product1-container099">
                      <span className="product1-text57">
                        Business Consulting
                      </span>
                      <span className="product1-text58">June 9, 2022</span>
                    </div>
                    <div className="product1-container100"></div>
                  </div>
                  <div className="product1-container101">
                    <span className="product1-text59">
                  ...
                  <div className="product1-container102">
                    <span className="product1-text60">Read More</span>
        ...
        <div className="product1-container103">
          <div className="product1-container104">
            <div className="product1-container105">
              ...
              <span className="product1-text62 text-1">
                <span>
            ...
            <div className="product1-container106">
              <div className="product1-container107">
                <span className="product1-text66">Enter your email</span>
              </div>
              <div className="product1-container108">
                <span className="product1-text67">Subscribe</span>
